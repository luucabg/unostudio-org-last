...
export const translations = {
  es: {
    ...
    pricing: {
      eyebrow: "Precios",
      title: "Planes claros para convertir tu web en un sistema de solicitudes.",
      body:
      ...
      plans: [
        {
          name: "Web Local",
          description: "Para negocios que necesitan una web clara, profesional y lista para recibir contactos.",
          price: "Desde 990€ + 99€/mes",
          ...
          features: [
            ...
            "SEO técnico básico",
            "Alojamiento y mantenimiento técnico",
            "Pequeños cambios mensuales",
          ],
          cta: "Reservar por 199€",
          paymentNote: "Reserva descontable del proyecto.",
          href: "/#booking",
          highlighted: false,
        },
        {
          name: "Sistema Presupuestos",
          description:
            "Para negocios que quieren una web más completa y un proceso claro para recibir presupuestos.",
          price: "Desde 1.490€ + 149€/mes",
          badge: "Recomendado",
          features: [
            "Todo lo de Web Local",
            "Hasta 5 páginas o secciones avanzadas",
            "Formulario guiado de presupuesto",
          ...
          cta: "Reservar por 299€",
          paymentNote: "Reserva descontable del proyecto.",
          href: "/#booking",
          highlighted: true,
        },
        {
          name: "Sistema Local Growth",
          description: "Para negocios que quieren mejorar mes a mes y atraer más solicitudes.",
          price: "Desde 2.490€ + 299€/mes",
          badge: "",
          features: [
            "Todo lo de Sistema Presupuestos",
            "SEO local mensual",
            "Optimización de Google Business Profile",
            "1 mejora o página nueva al mes",
            "Revisión mensual de solicitudes",
            "Sistema de reseñas",
            "Preparación para anuncios locales",
            "Soporte prioritario",
          ],
          cta: "Pedir propuesta",
          paymentNote: "Para negocios que quieren trabajar crecimiento mensual.",
          href: "/#booking",
          highlighted: false,
        },
      ],
    ...
    addons: {
      eyebrow: "Extras",
      title: "Añade más cuando la web ya esté funcionando.",
      body:
        "También podemos añadir panel de solicitudes, seguimiento, reseñas o anuncios cuando ya exista una base clara y medible.",
      items: [
        {
          name: "Panel de solicitudes",
          price: "",
          body: "Solicitudes ordenadas por nombre, servicio, estado y próxima acción.",
        },
        {
        ...
        },
        {
          ...
          price: "",
          body:
            "Campañas básicas cuando la web ya está preparada. La gestión empieza desde 350€/mes + inversión publicitaria.",
        },
      ],
    },
    booking: {
  ...
  en: {
    ...
    pricing: {
      eyebrow: "Pricing",
      title: "Clear plans to turn your website into a request system.",
      body:
      ...
      plans: [
        {
          name: "Local Website",
          description: "For businesses that need a clear, professional website ready to receive contacts.",
          price: "From €990 + €99/mo",
        ...
        },
        {
          name: "Quote System",
          description:
            "For businesses that want a more complete website and a clear process to receive quote requests.",
          price: "From €1,490 + €149/mo",
          badge: "Recommended",
          features: [
            "Everything in Local Website",
            "Up to 5 pages or advanced sections",
            "Guided quote request form",
            "WhatsApp with prepared message",
            "Basic contact measurement",
        ...
        },
        {
          ...
          description: "For businesses that want to improve month by month and attract more requests.",
          price: "From €2,490 + €299/mo",
          badge: "",
          features: [
            "Everything in Quote System",
            "Monthly local SEO",
            "Google Business Profile optimization",
            "1 improvement or new page per month",
            "Monthly request review",
            "Review system",
            "Preparation for local ads",
            "Priority support",
          ],
          cta: "Request proposal",
          paymentNote: "For businesses that want monthly growth work.",
          href: "/#booking",
          highlighted: false,
        },
      ],
    ...
    addons: {
      eyebrow: "Extras",
      title: "Add more once the website is working.",
      body:
        "We can also add a request panel, follow-up, reviews, or ads once there is a clear and measurable base.",
      items: [
        {
          name: "Request panel",
          price: "",
          body: "Requests organized by name, service, status and next action.",
        },
        {
        ...
        },
        {
          ...
          price: "",
          body:
            "Basic campaigns once the website is ready. Management starts from €350/mo + ad spend.",
        },
      ],
    },
    booking: {
