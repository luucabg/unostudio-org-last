  ...
  return (
    <section id="features" className="px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          {t.features.items.map((item, index) => {
            ...
            return (
              <div
                key={item.title}
                className="rounded-lg border border-zinc-800/70 bg-zinc-950/70 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition duration-300 hover:-translate-y-1 hover:border-sky-300/35"
              >
        ...
        <div className="mt-12 grid gap-6 rounded-lg border border-sky-300/20 bg-sky-300/[0.05] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] lg:grid-cols-[0.84fr_1.16fr] lg:items-center md:p-8">
          <div>
