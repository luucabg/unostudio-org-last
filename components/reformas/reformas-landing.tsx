...
const copyByLocale = {
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        ["¿Qué pasa con WhatsApp?", "Lo incorporamos cuando ayuda a responder con más contexto y a mantener el seguimiento ordenado. Si requiere un proveedor, licencia o consumo externo, su coste se explica antes."],
        ["¿Qué ocurre con los datos?", "Cada empresa accede únicamente a sus oportunidades. Los datos del cliente pueden exportarse si termina el servicio; los accesos y la protección de la información se definen antes de ponerlo en marcha."],
        ["¿El diagnóstico inicial tiene coste?", "No. La primera revisión para entender el proceso y comprobar si existe encaje no tiene coste ni compromiso."],
        ["¿Hay permanencia?", "No hay permanencia anual por defecto. Tras la implantación, el servicio continúa mes a mes y puede cancelarse con 30 días de preaviso."],
        ["¿Tengo que cambiar las herramientas que ya usamos?", "No necesariamente. Mantenemos o conectamos lo que ya funciona y solo proponemos cambios cuando existe una razón clara."],
      ],
    },
    diagnosis: {
      eyebrow: "Diagnóstico",
      ...
      body:
        "Cuéntame cómo entran hoy las solicitudes y qué ocurre después. La primera revisión no tiene coste ni compromiso; te diré si tiene más sentido mejorar la web, el seguimiento o ambos.",
      bullets: ["Revisión del recorrido actual", "Siguiente paso concreto", "Primera revisión sin coste"],
  ...
  en: {
    ...
    faq: {
      ...
      items: [["Do I need to rebuild my website?", "No. If it explains the service clearly and generates useful enquiries, we work with it. We only recommend a change when it limits the system."], ["How is it adapted to my company?", "We start by reviewing how your team receives, handles and follows enquiries today. Then we configure only the stages and alerts the team needs."], ["What happens with WhatsApp?", "We include it when it helps the team respond with more context and keep follow-up organised. If it requires an external provider, licence, or usage fee, that cost is explained in advance."], ["What happens to the data?", "Each company can only access its own opportunities. Client data can be exported if the service ends; access and information protection are defined before the system goes live."], ["Does the initial diagnosis cost anything?", "No. The first review to understand the process and check fit is free and carries no commitment."], ["Is there a commitment period?", "There is no annual lock-in by default. After implementation, the service runs month to month and can be cancelled with 30 days' notice."], ["Do we need to replace the tools we already use?", "Not necessarily. We keep or connect what already works and only propose changes when there is a clear reason."]],
    },
    diagnosis: {
      eyebrow: "Diagnosis",
      title: "Let us see where your opportunities are getting stuck.",
      body: "Tell me how enquiries arrive today and what happens next. The first review is free and carries no commitment; I will tell you whether it makes more sense to improve the website, follow-up, or both.",
      bullets: ["Current journey review", "One concrete next step", "First review is free"],
